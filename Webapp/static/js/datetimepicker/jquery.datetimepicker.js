	...
	$.fn.datetimepicker = function (opt, opt2) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev" title="上一月"></button><button type="button" title="当前时间" class="xdsoft_today_button"></button>' +
					'<div class="xdsoft_label xdsoft_month" title="下一月"><span></span><i></i></div>' +
