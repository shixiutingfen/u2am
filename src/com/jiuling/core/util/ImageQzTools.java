...
public class ImageQzTools {
	...
	public ImageQzTools(String path) {
		setPath(path);
		setFile();
		setHeight(); // 取得图片高
		setWidth(); // 取得图片宽
	...
	public static void main(String[] argv) throws Exception { // Pic类的测试函数
																// 已经全部通过了 ioi
		ImageQzTools pic = new ImageQzTools("d:\\1.jpg");// 加载一张图片
		...
		ImageIO.write(image1, "jpg", new File("d:\\3.jpg"));
		...
		ImageIO.write(image2, "jpg", new File("d:\\4.jpg"));
