package com.jiuling.core.feature.orm.mybatis;
...
import com.jiuling.core.feature.orm.dialect.Dialect;
import com.jiuling.core.feature.orm.dialect.DialectFactory;
...
public class PageStatementInterceptor implements Interceptor {
    ...
    private final static Logger logger = LoggerFactory.getLogger(PageStatementInterceptor.class);
